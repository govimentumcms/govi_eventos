  ...
  <div class="pure-g">
	  ...
	  <div class="pure-g datos">
	  	<div class="pure-u-1-2">
	  		<?php print render($content['field_multimedia_evento']); ?>
	  	</div>
	  	<div class="pure-u-1-2">
	  		<div class="contenedor-info-eventos">
	  			<h2>Fecha de inicio:</h2>
	  			<p> <?php print format_date(strtotime($node->field_fecha_evento['und'][0]['value']), 'custom', 'd F Y, H:i');?> </p>
	  			<h2>Fecha de fin:</h2>
	  ...
	  <div class="content"<?php print $content_attributes; ?>>	
	      <?php
	      // Se ocultan los comentarios y enlaces de tal forma que 
	      // puedan ser renderizados después
	  ...
	  <?php // Renderiza enlaces y comentarios al final de la noticia ?>
